...
namespace Services.Migrations
{
    ...
    [Migration("20211022103835_AmendedDiarySlotsToRepairInstruction")]
    partial class AmendedDiarySlotsToRepairInstruction
    {
            ...
            modelBuilder.Entity("Models.BaseModels.Diary.DiarySlot", b =>
                {
                    ...
                    b.HasIndex("RepairInstructionId");
            ...
            modelBuilder.Entity("Models.BaseModels.Repair.RepairCategory", b =>
                {
                    ...
                    b.Property<string>("RepairCategoryDescription")
                        .IsRequired()
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)");
            ...
            modelBuilder.Entity("Models.BaseModels.Diary.DiarySlot", b =>
                {
                    ...
                    b.HasOne("Models.BaseModels.Repair.RepairInstruction", "RepairInstruction")
                        .WithMany()
                        .HasForeignKey("RepairInstructionId");
                    ...
                    b.Navigation("RepairInstruction");
